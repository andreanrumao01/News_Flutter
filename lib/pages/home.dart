...
import 'package:newsapp1/models/article_model.dart';
import 'package:newsapp1/models/category_model.dart';
import 'package:newsapp1/models/slider_model.dart';
import 'package:newsapp1/pages/article_view.dart';
import 'package:newsapp1/pages/category_news.dart';
import 'package:newsapp1/services/data.dart';
import 'package:newsapp1/services/news.dart';
...
class _HomeState extends State<Home> {
  ...
  getSlider() async {
    ...
    sliders = slider.sliders;
    setState(() {}); // Update the state after fetching sliders
  }
              ...
              child: Container(
                child: Column(
                  ...
                  children: [
                    ...
                    // Check if sliders list is empty before building CarouselSlider
